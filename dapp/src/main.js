...
export default class Main {
    ...
    loadManifest() {
        ...
        loader
            ...
            .add('boxEmpty', require('../img/items/boxEmpty.png'))
            .add('boxGold', require('../img/items/boxGold.png'))
            .add('boxLock', require('../img/items/boxLock.png'))
            // .add('btnCashout', require('../img/items/btnCashout.png'))
            // .add('btnFacebook', require('../img/items/btnFacebook.png'))
            ...
            .add('logoDaoCasino', require('../img/items/logoDaoCasino.png'))
            ...
            .add('boxSelected', require('../img/items/aure.png'))
            .add('boxOver', require('../img/items/boxOver.png'))
